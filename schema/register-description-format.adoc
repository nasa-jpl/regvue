...
a|`reset`
|No
|integer, string, or <<reset-objects,Reset>> object
...
If no reset name is specified (i.e. an integer or string type is used), the name of the reset will be that specified by the closest `default_reset` property.
...
String values can be binary (e.g. "0b101"), decimal (e.g. "5") or hexadecimal (e.g. "0x5").
