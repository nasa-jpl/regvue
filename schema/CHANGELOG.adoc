...
* The `links` property on the link:register-description-format.adoc#root-object[Root] object has been changed from an object of test/URL pairs to an array of objects with `text` and `href` properties.
