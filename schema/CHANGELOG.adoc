...
* The link:register-description-format.adoc#root-object[Root] object `display_name` property is now required
+
Previously, this was optional.
In Regvue v1.0 (schema v1), a missing Root `display_name` property is now an error.
